...
- Pushing a version tag such as `v0.6.2`, if tag-triggered builds are enabled in the workflow
...
For CrossTerm 0.6.2, the expected installer is:

```text
dist\installer\CrossTerm-0.6.2-windows-x64-setup.exe
```
