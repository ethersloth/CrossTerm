...
#include "../../../src/connections/SshConnection.h"
...
namespace {
struct qt_meta_tag_ZN13SshConnectionE_t {};
} // unnamed namespace

template <> constexpr inline auto SshConnection::qt_create_metaobjectdata<qt_meta_tag_ZN13SshConnectionE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<SshConnection, qt_meta_tag_ZN13SshConnectionE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject SshConnection::staticMetaObject = { {
    QMetaObject::SuperData::link<IConnection::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13SshConnectionE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13SshConnectionE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN13SshConnectionE_t>.metaTypes,
    nullptr
} };
...
void *SshConnection::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN13SshConnectionE_t>.strings))
