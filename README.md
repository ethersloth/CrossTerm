...
This creates `dist\installer\CrossTerm-0.5.1-windows-x64-setup.exe`. The installer places the complete deployed package in `C:\Program Files\CrossTerm`, creates a Start Menu shortcut, and offers a desktop shortcut. End users do not need Qt or Visual Studio installed.
