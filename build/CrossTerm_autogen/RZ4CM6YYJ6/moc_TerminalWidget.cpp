...
#include "../../../src/widgets/TerminalWidget.h"
...
void TerminalWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->reconnectRequested(); break;
        case 1: _t->appendIncoming((*reinterpret_cast<std::add_pointer_t<QByteArray>>(_a[1]))); break;
        case 2: _t->showError((*reinterpret_cast<std::add_pointer_t<QString>>(_a[1]))); break;
        case 3: _t->updateCursorBlink(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (TerminalWidget::*)()>(_a, &TerminalWidget::reconnectRequested, 0))
            return;
    }
}
...
// SIGNAL 0
void TerminalWidget::reconnectRequested()
{
